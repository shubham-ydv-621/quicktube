    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _footerButton(Icons.leaderboard, "Leaderboard", context, '/leaderboard'),
          _counterButton(Icons.visibility, reelsScrolledToday),
          isShortsScreen
              ? _autoScrollButton()
              : _footerButton(Icons.school, "QuickCampus", context, '/quickcampus'),
        ],
      ),
    );
  }
